...
@section('content')
    ...
    <div class="main penjelasan">
        ...
        <div class="media position-relative">
            ...
            <div class="col-9 bagian2" style="height: 260px;
            display: flex;
            flex-direction: column;
            justify-content: center;">
                <div class="garis1 ">
                    <p class="font-weight-normal deskripsi ">"BRAWIJAYA TOURNAMENT merupakan acara kegiatan yang berkolaborasi dengan Unit Kegiatan Mahasiswa Universitas BRAWIJAYA yang terdiri dari beberapa rangkaian kompetisi perlombaan dalam bidang olahraga..
                        <br>
                        <br>
                        BRAWIJAYA TOURNAMENT ini merupakan kegiatan perlombaan yang dilakukan antar mahasiswa se-Indonesia."
                    </p>
                </div>
            </div>
        </div>
