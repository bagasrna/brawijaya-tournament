<template>
    <div>
        ...
        <div v-if="data" class="content__">
            <h2 class="h2">Form Pendaftaran Tim Mobile Legends</h2>
            <div class="info__">
                ...
                <Button
                    ...
                    @click="submitForm"
                    :disabled="data.players.length < minPlayer || data.pembayaran == null"
                    ...
                    <table class="table__" width="100%">
                        ...
                        <tbody>
                            <tr v-for="(player, i) in data.players" :key="player.id">
                                ...
                                <td>{{player.posisi}}</td>
                                <td align="center">
                                    <Button @click="viewPlayer(i)" icon="md-eye"></Button>
                                    <Button
                                        v-if="data.status == 'draft'"
                                        @click="editPlayer(i)"
                                        type="warning"
...
export default {
    ...
    methods: {
        ...
        async getTeam() {
            var res = await this.callApi("get", "/client/competition?type=ml");
