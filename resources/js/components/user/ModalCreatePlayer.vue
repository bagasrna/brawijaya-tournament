    ...
    >
        <Form ref="form" :model="data" :rules="formRules" class="form__">
            <div class="left">
                ...
                <FormItem v-if="comptt_name !='ml'" prop="gender">
                ...
                <FormItem v-if="comptt_name == 'ml'" prop="email">
                    <Input v-model="data.email" type="email" placeholder="Email" />
                </FormItem>
                <FormItem v-if="comptt_name == 'ml' || comptt_name == 'pubg'" prop="handphone">
                    <Input v-model="data.handphone" placeholder="No. Handphone/Line" />
                </FormItem>
                <FormItem v-if="comptt_name == 'ml' " prop="nickname">
                    <Input v-model="data.nickname" placeholder="Nickname" />
                </FormItem>
                <FormItem v-if="comptt_name == 'ml' || comptt_name == 'pubg'" prop="game_id">
                    <Input
                        v-model="data.game_id"
                        :placeholder="comptt_name== 'ml'? 'Server ID': 'ID/Username' "
                    />
                </FormItem>
                <FormItem v-if="comptt_name == 'ml' || comptt_name == 'pubg'" prop="posisi">
