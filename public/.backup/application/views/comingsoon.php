...
<body>
	...
	<div class="bg-g1 size1 flex-w flex-col-c-sb p-l-15 p-r-15 p-t-55 p-b-35 respon1">
		...
		<span class="s1-txt3 txt-center">
			...
			<div>
				<a href="http://www.instagram.com/orsimbrawijaya" class="fab fa-instagram fa-2x" style="margin-right: 10px; color: #0C5B79"></a>
				<a href="http://twitter.com/ORSIM_brawijaya" class="fab fa-twitter fa-2x" style="margin-right: 10px; color: #0C5B79"></a>
				<a href="https://line.me/R/ti/p/%40qas3529n" class="fab fa-line fa-2x" style="margin-right: 10px; color: #0C5B79"></a>
				<a href="https://www.youtube.com/channel/UCKUbs4ecoWPqNlNAoZqCnNw" class="fab fa-youtube fa-2x" style="margin-right: 10px; color: #0C5B79"></a>
			</div>
		</span>
...
<!--===============================================================================================-->
	<script src="cs/vendor/countdowntime/moment.min.js"></script>
	<script src="cs/vendor/countdowntime/moment-timezone.min.js"></script>
	<script src="cs/vendor/countdowntime/moment-timezone-with-data.min.js"></script>
	<script src="cs/vendor/countdowntime/countdowntime.js"></script>
	<script>
		$('.cd100').countdown100({
			// Set Endtime here
...
<!--===============================================================================================-->
	<script src="cs/vendor/tilt/tilt.jquery.min.js"></script>
	<script >
		$('.js-tilt').tilt({
			scale: 1.1
		})
