      ...
      <div class="col-lg-4 offset-lg-4 col-12">
        <div class="card myCard" style="border-radius: 10px; background-color: #F5F4F5">
          <div class="mt-4"> 
            ...
            <video autoplay loop muted class="w-100" playsinline>
              <source src="../../assetapps/img/intro_logo.mp4" type="video/mp4">
            </video>
          </div>
          <div class="text-center mt-4">
            <h4>SIAM AUTH</h4>
          </div>
          <form class="container col-lg-10" method="post" action="../login/ayo_login">
